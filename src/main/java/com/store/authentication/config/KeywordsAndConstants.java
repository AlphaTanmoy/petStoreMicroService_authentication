...
public class KeywordsAndConstants {
    ...
    public static final String RABBIT_MQ_EXCHANGE_AUTHENTICATION="RABBIT_MQ_EXCHANGE_AUTHENTICATION";
    public static final String RABBIT_MQ_QUEUE_FOR_EVENTS_AUTHENTICATION = "RABBIT_MQ_QUEUE_FOR_EVENTS_AUTHENTICATION";
    public static final String RABBIT_MQ_ROUTE_KEY_FOR_EVENTS_AUTHENTICATION = "RABBIT_MQ_ROUTE_KEY_FOR_EVENTS_AUTHENTICATION";
    public static final String RABBIT_MQ_QUEUE_FOR_REQUEST_SANITATION_AUTHENTICATION = "RABBIT_MQ_QUEUE_FOR_REQUEST_SANITATION_AUTHENTICATION";
    public static final String RABBIT_MQ_ROUTE_KEY_FOR_REQUEST_SANITATION_AUTHENTICATION = "RABBIT_MQ_ROUTE_KEY_FOR_REQUEST_SANITATION_AUTHENTICATION";
    public static final String RABBIT_MQ_QUEUE_FOR_LOGIN_OR_SIGNUP_OTP_AUTHENTICATION = "RABBIT_MQ_QUEUE_FOR_LOGIN_OR_SIGNUP_OTP_AUTHENTICATION";
    public static final String RABBIT_MQ_ROUTE_KEY_FOR_LOGIN_OR_SIGNUP_OTP_AUTHENTICATION = "RABBIT_MQ_ROUTE_KEY_FOR_LOGIN_OR_SIGNUP_OTP_AUTHENTICATION";
    public static final String RABBIT_MQ_ROUTE_KEY_FOR_FOREX_DATA_AUTHENTICATION = "RABBIT_MQ_ROUTE_KEY_FOR_FOREX_DATA_AUTHENTICATION";
    public static final String RABBIT_MQ_QUEUE_FOR_FOREX_DATA_AUTHENTICATION = "RABBIT_MQ_QUEUE_FOR_FOREX_DATA_AUTHENTICATION";


    public static final Integer MAXIMUM_DEVICE_CAN_CONNECT = 3;
    public static final Integer OTP_EXPIRED_IN_MINUTES = 10;
